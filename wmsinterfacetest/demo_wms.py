...
#测试商品列表接口
def test_product_list(token_base64):
    ...
    try:
        ...
        test_data["product_record"] = records[0]
        ...
        return False
#测试商品提交接口
def test_submit_product(token_base64):    
...
def run_tests():
    ...
    # 执行测试用例
    tests = [
        ("商品列表", test_product_list, token_base64),
        ("商品提交", test_submit_product, token_base64)
    ]
